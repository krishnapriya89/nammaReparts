...
@section('title', 'Parts Listing Page')
    ...
    <section>
        <div class="container">
            <div class="banner-inner-wrapper">
                <div class="row">
                    <div class="col-sm-9">
                        <h1 class="main-title">{{ $category->category_name }}</h1>
                    </div>
    ...
    <section>
        <div class="container">
            ...
            <div>
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="main-title-details mt-5"> {{ $category->category_name}} Parts</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product-block-one week-deal-one">
                        <a href="details5.html">
                            ...
                            <div class="product-block-one-image">
                                <div class="image"><img src="{{$part->part_image}}" alt="parts"></div>
                            </div>
                            <div class="product-block-one-cintent">
                                <h4 class="fs_15 product-item-tile__title">{{$part->part_name}}</h4>
                                <div class="price-container">
                                    <div class="price fs_15 fw_medium">₹268.99 <span>₹{{$part->price}}</span></div>
                                </div>
                                <div>
                                    <h6 class="details-brand-name">{{$part->vehicle->model}}</h6>
                                </div>
                            </div>
            ...
            {{-- <div class="th-block-categories__list">
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/car-metal-bearings-500x500-1-300x300.webp"></div>
                        <div class="icon-content">
                            ...
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                            Clutch Bearings </a></li>
                                <li>
                                    <a href="javascript:;">
                            Front Wheel Bearings </a></li>
                                <li>
                                    <a href="javascript:;">
                            Front Wheel Hubs </a></li>
                                <li>
                                    <a href="javascript:;">
                            Rear Wheel Bearings </a></li>
                                <li>
                                    <a href="javascript:;">
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/Body-Parts-300x300.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Body Parts </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                A/C Blower Motor </a></li>
                                <li>
                                    <a href="javascript:;">
                                Bumper Brackets </a></li>
                                <li>
                                    <a href="javascript:;">
                                Bumper Nozzle Caps </a></li>
                                <li>
                                    <a href="javascript:;">
                                Coolant Bottle Caps</a></li>
                                <li>
                                    <a href="javascript:;">
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/Brake-Parts-300x300.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Brakes </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                Caliper Bracket </a></li>
                                <li>
                                    <a href="javascript:;">
                                Caliper Kits </a></li>
                                <li>
                                ...
                                <li>
                                    <a href="javascript:;">
                                Front Brake Pads </a></li>
                                <li>
                                    <a href="javascript:;">
                                        Rear Brake Discs</a></li>
                                <li>
                                    <a href="javascript:;">
                                                Rear Brake Liners </a>
                                </li>
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/EDYHNK7319-300x300.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Clutch Components </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                Clutch Plates And Pressure Plates  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Fly Wheel Assembly  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Sleave Cylinders  </a></li>
                                <li>
                                    <a href="javascript:;">
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/automotive-control-cable-500x500-1-300x300.webp"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Control Cables </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                Back Door ( Dicky ) Cables  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Bonnet Cables </a></li>
                                <li>
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/eletrics.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">
                                Electrics </h4>
                            <ul class="th-category-card__children">
                                ...
                                <li>
                                    <a href="javascript:;">
                                Air Mass Sensors  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Fuel Gauge  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Head Light Bulbs  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Speedo Sensors  </a></li>
                            </ul>
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/Engine-Parts-300x300.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Engine </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                Air Cleaner Assembly  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Air Intake Hose  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Alternator Hose  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Alternator Pulleys  </a></li>
                                <li>
                                    <a href="javascript:;">
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/Filters-300x300.jpg"></div>
                        <div class="icon-content">
                ...
                <div class="th-block-categories__item">
                    <div class="icon-bx-wraper left">
                        <div class="icon-bx-sm"><img src="images/steering-and-suspension-parts.jpg"></div>
                        <div class="icon-content">
                            <h4 class="parts-title">Steering And Suspension </h4>
                            <ul class="th-category-card__children">
                                <li>
                                    <a href="javascript:;">
                                Airmatic Compressor Assemblies  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Balance Rod Bushes  </a></li>
                                <li>
                                    <a href="javascript:;">
                                Bushing Kits  </a></li>
                                <li>
                                ...
                                <li>
                                    <a href="javascript:;">
                                Dead Axle Bushes </a></li>
                                <li>
                                    <a href="javascript:;">
                                        Front Coil Pads  </a></li>
                                <li>
                                    <a href="javascript:;">
                                                Front Shock Absorber Bearings  </a></li>
                                <li>
                                    <a href="javascript:;">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="product-block-one week-deal-one">
                    <div class="ribon fs_13">8%</div>
                    <div class="product-block-one-image">
                        <div class="image"><img src="images/f-1.png" alt="parts"></div>
                    </div>
                    <div class="product-block-one-cintent">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-block-one week-deal-one">
                    <div class="ribon fs_13">8%</div>
                    <div class="product-block-one-image">
                        <div class="image"><img src="images/f-2.png" alt="parts"></div>
                    </div>
                    <div class="product-block-one-cintent">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-block-one week-deal-one">
                    ...
                    <div class="product-block-one-image">
                        <div class="image"><img src="images/f-3.png" alt="parts"></div>
                    </div>
                    <div class="product-block-one-cintent">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-block-one week-deal-one">
                    <div class="ribon fs_13">8%</div>
                    <div class="product-block-one-image">
                        <div class="image"><img src="images/f-4.png" alt="parts"></div>
                    </div>
                    <div class="product-block-one-cintent">
