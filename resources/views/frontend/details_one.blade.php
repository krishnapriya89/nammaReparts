        ...
        <div class="banner-inner-wrapper">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="user-rating d-flex justify-content-lg-start justify-content-md-center justify-content-center">
                        <div class="d-flex flex-column align-items-left">
                            <div><span class="count">Engine </span><span>K</span></div>
                            <p class="pt-1">01</p>
                        </div>
                        <hr>
                        <div class="d-flex flex-column align-items-left  ms-1">
                            <span class="count">Engine type </span>
                            <p class="pt-1">Petrol </p>
                        </div>
                        <hr>
                        <div class="d-flex flex-column align-items-left ms-1">
                            <span class="count">Body type </span>
                            <p class="pt-1">Saloon </p>
                        </div>
                    </div>

                    <div>
                        <p class="mt-4 mb-5">
                            The Maruti 1000 is a compact front wheel drive vehicle with a transverse engine. The Indian manufacturer offers compact 4-door hatchbacks to buyers. The prototype was the Suzuki 1000 model from the leader of the Japanese car industry. Maruti 1000 parts are distinguished by quality and reliability.
                        </p>
                    </div>
                ...
                <table class="responsive-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-title="" data-type="currency"><a href="{{route('details_two')}}" class="btn choose-btn">Choose</a> </td>
                        </tr>
                        <tr>
                            <th scope="row">1.0L </th>
