...
@section('title', 'edit Sub Category') <!-- Title section -->
<style>
    .red-text{
        color:red;
    }
            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" action="{{route('subcategory.update',$subcategory->id)}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="input1" value="{{$subcategory->subcategory_name}}" name="sub_category_name">
                                    <br>
